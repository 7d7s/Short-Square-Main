...
export const metadata: Metadata = {
    title: "Cookie Policy | ShotSquare Studio",
    description:
        "Read the ShotSquare Studio Cookie Policy to learn how we use cookies and similar technologies to improve website functionality, performance, analytics, and your browsing experience.",
    alternates: {
        canonical: "https://www.shotsquare.com/cookie-policy",
    },
    robots: {
        index: true,
        follow: true,
    ...
    openGraph: {
        title: "Cookie Policy | ShotSquare Studio",
        description:
            "Learn how ShotSquare Studio uses cookies and similar technologies on our website.",
        url: "https://www.shotsquare.com/cookie-policy",
